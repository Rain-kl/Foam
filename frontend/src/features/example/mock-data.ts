...
export const MOCK_CHAT_SEED: ExampleChatMessage[] = [
  {
    ...
    role: 'assistant',
    content:
      'Welcome to the Foam chat page template. Messages stay in local state so you can explore the layout without backend APIs.',
