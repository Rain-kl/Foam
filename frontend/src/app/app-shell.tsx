...
const exampleNavigation = [
  { href: '/example/component', label: 'nav.component', icon: Component },
  {
    href: '/example/page/dashboard',
    label: 'nav.pageDashboard',
    icon: LayoutDashboard,
  },
  { href: '/example/page/table', label: 'nav.pageTable', icon: Table2 },
  {
    href: '/example/page/chat',
    label: 'nav.pageChat',
...
export function AppShell() {
  ...
  function navigationLinks(items: typeof exampleNavigation): ReactNode {
  ...
  const navigationContent = (
    ...
    >
      ...
      <div className='space-y-1'>{navigationLinks(exampleNavigation)}</div>
    </nav>
  );
